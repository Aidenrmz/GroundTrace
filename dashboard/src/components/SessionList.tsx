  ...
  return (
    <div className="w-60 bg-[#1a1a1a] border-r border-[#2a2a2a] flex flex-col h-full">
      ...
      <div className="p-4 border-b border-[#2a2a2a]">
        <h1 className="text-lg font-semibold text-[#e8e8e8] mb-3">GroundTrace</h1>
        <button
          ...
          <>
            ...
            <div className="divide-y divide-[#2a2a2a]">
              {historicalSessions.map((session) => (
                ...
                >
                  <div className="flex items-start gap-2 mb-1">
                    <span className="inline-block w-2 h-2 border border-[#6a6a6a] rounded-sm mt-1 flex-shrink-0"></span>
