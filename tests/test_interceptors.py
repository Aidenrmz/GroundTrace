...
from groundtrace.interceptors import get_installed, install_all, uninstall_all
...
class TestOpenAIInterceptor:
    ...
    def test_records_llm_request_on_call(self):
        ...
        with patch("groundtrace.interceptors.openai_patch.bus", self.bus):
...
class TestAnthropicInterceptor:
    ...
    def test_records_anthropic_request(self):
        ...
        with patch("groundtrace.interceptors.anthropic_patch.bus", self.bus):
            wrapped = self.interceptor._wrap_create(mock_original_create)
            mock_self = MagicMock()
...
class TestChromaInterceptor:
    ...
    def test_records_vector_query(self):
        ...
        with patch("groundtrace.interceptors.chroma_patch.bus", self.bus):
...
class TestPGVectorInterceptor:
    ...
    def test_detects_vector_query_with_cosine_operator(self):
        ...
        from groundtrace.interceptors.pgvector_patch import _is_vector_query
    ...
    def test_extracts_sql_from_text_statement(self):
        ...
        from groundtrace.interceptors.pgvector_patch import _get_sql_string
    ...
    def test_builds_event_from_rows_with_common_columns(self):
        ...
        from groundtrace.interceptors.pgvector_patch import _build_event_from_rows
    ...
    def test_buffers_result_rows(self):
        ...
        from groundtrace.interceptors.pgvector_patch import _BufferedResult
        from collections import namedtuple
