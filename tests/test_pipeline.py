...
Note: These tests use the global bus (groundtrace.session_bus.bus) since
...
from groundtrace.pipeline import setup_auto_attribution, _on_llm_response, _run_attribution
from groundtrace.session_bus import bus as global_bus
...
class TestAutoAttributionPipeline:
    ...
    def setup_method(self):
        ...
        import groundtrace.pipeline as pipeline_module
    ...
    def test_attribution_triggered_after_llm_response(self):
        ...
        with patch(
            "groundtrace.detection.hallucination._get_model", return_value=fake_model
        ):
    ...
    def test_attribution_handles_detector_failure(self):
        ...
        with patch(
            "groundtrace.detection.hallucination.HallucinationDetector.detect",
