...
from groundtrace.types import AttributionResult, LLMResponseEvent, RetrievedChunk
...
_executor = ThreadPoolExecutor(max_workers=3, thread_name_prefix="groundtrace-attr")
