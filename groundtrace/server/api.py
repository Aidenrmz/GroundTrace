"""REST API endpoints for the GroundTrace dashboard."""
...
from groundtrace.interceptors import get_installed
from groundtrace.session_bus import bus
from groundtrace.types import AttributionResult, Session
...
async def deep_analyze_session(session_id: str, request_id: str | None = None) -> AttributionData:
    ...
    # Build LLM caller
    from groundtrace.pipeline import _make_llm_caller
    from groundtrace.attribution.perturbation import PerturbationAttributor
    from groundtrace.detection.hallucination import HallucinationDetector
    from groundtrace.types import AttributionResult
